...
public class SettingsController implements Initializable  {
	...
	private boolean setValues() {
		...
		try {
			...
			// A bare parse failure reports 'For input string: "x"'; say what to do instead.
			if(detail == null || detail.startsWith("For input string"))
				detail = "Every field must be a number.";
			rootController.popUp(detail);
			return false;
		}
		return true;
	}
